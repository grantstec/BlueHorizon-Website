...
>[!important]
>Sgt. Challman needs 48 hours notice for us to use the astro truck
- We OFFICIALLY deciding to use trailer for solids, NOT making a new test stand
	- Jacob will also look into moving liquid testing back to trailer so that we can get used to it
